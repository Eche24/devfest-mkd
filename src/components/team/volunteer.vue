<template>
    <v-container class="pa-0">
         ...
         <p class="google-font" style="font-size:130%;">Volunteers</p>
                <v-divider></v-divider> 
        <v-layout wrap align-start justify-start row fill-height class="mt-5 mb-0 ">

    
            
            <v-flex xs6 sm3 md2 lg2 v-for="(item,i) in TeamDetails" :key="i" class="text-xs-center " 
                ...
                <div 
                    ...
                    <p class="mt-2 mb-0 google-font" style="font-size:130%">{{item.name}}</p>
...
<script>
import TeamDetails from '@/assets/data/volunteer.json'
export default {
    data() {
        return {
