...
<v-container class="pa-0 my-0">
     ...
     <div style="border-radius: 5px; border:1px solid #EEEEEE;min-height:120px box-shadow: #ffffff0a 1px 1px 1px; " class="ma-1 pa-5" v-for="person in schedule2019" :key="person.sessionId">
...
export default {
  ...
  created () {
    db.collection("schedule2019").orderBy("sessionId", "asc").where("track", "==",'web')
    .onSnapshot(res => {
