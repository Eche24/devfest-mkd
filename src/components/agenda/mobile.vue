...
<v-container class="pa-0 my-0">
        ...
        <div style="border-radius: 5px; border:1px solid purple;min-height:180px" class="ma-1 pa-5" v-for="person in schedule2019" :key="person.id">
...
export default {
  ...
  created () {
    db.collection("schedule2019").where("track", "==",'mobile')
    //  .orderBy("", "desc")
    .onSnapshot(res => {
